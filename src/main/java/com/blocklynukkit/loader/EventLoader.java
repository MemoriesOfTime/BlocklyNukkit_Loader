...
//        player.createBossBar()
    ...
    public void onEntityDamageByEntityEvent(EntityDamageByEntityEvent event) {
        ...
        if (entity instanceof BNNPC || entity instanceof VanillaNPC) {
            event.setAttackCooldown(0); //防止多弹射物在rpg服混战中冲突导致不伤害
        }
    ...
    public void onChunkUnload(ChunkUnloadEvent event) {
        ...
        for (Entity entity : event.getChunk().getEntities().values()) {
            ...
            if (entity.getName().equals("BNNPC") || entity.getName().equals("BNFloatingText") || entity.getName().equals("BNModel") || entity.getName().equals("VanillaNPC")) {
                event.setCancelled();
            }
        }
