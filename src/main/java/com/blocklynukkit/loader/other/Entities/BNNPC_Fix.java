...
public class BNNPC_Fix extends EntityHuman {
    public BNNPC_Fix bnnpc;
    ...
    public BNNPC_Fix(FullChunk chunk, CompoundTag nbt, String name, Clothes clothes) {
    ...
    public BNNPC_Fix(FullChunk chunk, CompoundTag nbt, String name, Clothes clothes,int calltick, String callback){
        this(chunk, nbt, name, clothes);
        calltimetick = calltick;
        callbackfunction=callback;
    }
    public BNNPC_Fix(FullChunk chunk, CompoundTag nbt, String name, Clothes clothes,int calltick, String callback, String attackcall){
