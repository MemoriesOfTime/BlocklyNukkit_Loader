        ...
        for (Vector3 vector3 : list) {
            ...
            if (xIsInt && zIsInt) {
                if (canPassThroughBlock(level.getBlock(new Vector3(vector3.getX(), vector3.getY() - 1, vector3.getZ()), false)) ||
                        ...
                        canPassThroughBlock(level.getBlock(new Vector3(vector3.getX(), vector3.getY() - 1, vector3.getZ() - 1), false))) return true;
            } else if (xIsInt) {
                if (canPassThroughBlock(level.getBlock(new Vector3(vector3.getX(), vector3.getY() - 1, vector3.getZ()), false)) ||
                        canPassThroughBlock(level.getBlock(new Vector3(vector3.getX() - 1, vector3.getY() - 1, vector3.getZ()), false))) return true;
            } else if (zIsInt) {
                if (canPassThroughBlock(level.getBlock(new Vector3(vector3.getX(), vector3.getY() - 1, vector3.getZ()), false)) ||
                        canPassThroughBlock(level.getBlock(new Vector3(vector3.getX(), vector3.getY() - 1, vector3.getZ() - 1), false))) return true;
            } else {
                if (canPassThroughBlock(level.getBlock(new Vector3(vector3.getX(), vector3.getY() - 1, vector3.getZ()), false))) return true;
            }
        }
        return false;
    }
